...
namespace WindowsFormsLinq
{
    public partial class Form1 : Form
    {
        ...
        private void dataGridView1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            //var detail = from det in dc.Order_Details where det.OrderID == detID
            //select det;
        ...
        {
            int detID = Convert.ToInt32(orderGrid.CurrentRow.Cells[0].Value.ToString());
            var detail = from det in dc.Order_Details
                         where det.OrderID == detID
                         select det;
            orderDetGrid.DataSource = detail;
        }
